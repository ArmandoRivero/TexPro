...
/* Private defines -----------------------------------------------------------*/
#define DRV_GREEN_Pin GPIO_PIN_2
#define DRV_GREEN_GPIO_Port GPIOE
#define debug_out_Pin GPIO_PIN_3
#define debug_out_GPIO_Port GPIOE
#define DRV_RED_Pin GPIO_PIN_4
#define DRV_RED_GPIO_Port GPIOE
#define DRV_BLUE_Pin GPIO_PIN_5
#define DRV_BLUE_GPIO_Port GPIOE
#define B1_Pin GPIO_PIN_13
#define B1_GPIO_Port GPIOC
#define TEST_PIN_Pin GPIO_PIN_7
#define TEST_PIN_GPIO_Port GPIOF
#define PIN_TEST1_Pin GPIO_PIN_9
#define PIN_TEST1_GPIO_Port GPIOF
...
#define PIN_TEST2_Pin GPIO_PIN_1
#define PIN_TEST2_GPIO_Port GPIOG
...
#define SP_GPIO_Port GPIOD
#define CDSCLK2_Pin GPIO_PIN_12
#define CDSCLK2_GPIO_Port GPIOD
#define ADCCLK_Pin GPIO_PIN_13
#define ADCCLK_GPIO_Port GPIOD
